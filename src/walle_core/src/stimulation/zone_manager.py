...
class ZoneManager:
    def __init__(self):
        ...
        self.zone_a = {
            'min': Point(
                x=rospy.get_param('~zone_a_min_x', 1.0),
                y=rospy.get_param('~zone_a_min_y', 1.0),
                z=0),
            'max': Point(
                x=rospy.get_param('~zone_a_max_x', 2.0),
                y=rospy.get_param('~zone_a_max_y', 2.0),
                z=0),
        ...
        self.zone_b = {
            'min': Point(
                x=rospy.get_param('~zone_b_min_x', 2.5),
                y=rospy.get_param('~zone_b_min_y', -0.5),
                z=0),
            'max': Point(
                x=rospy.get_param('~zone_b_max_x', 3.0),
                y=rospy.get_param('~zone_b_max_y', 0.5),
                z=0),
            'height': rospy.get_param('~table_height', 0.75),
            'description': '本色箱子区'
        }
        ...
        self.zone_c = {
            'min': Point(
                ...
                y=rospy.get_param('~zone_c_min_y', -0.5),
                z=0),
            'max': Point(
                x=rospy.get_param('~zone_c_max_x', -0.5),
                y=rospy.get_param('~zone_c_max_y', 0.5),
                z=0),
            'height': rospy.get_param('~table_height', 0.75),
            'description': '彩色箱子区'
        }
        ...
        rospy.loginfo('区域管理器已启动 (zone_a 对齐 Gazebo 桌面区域)')
        self.publish_zones()
